  ...
  <div class="row pr-3">
    <div class="col-md-2 col-2 pr-0">
      <div class="avatar-post ml-3">
        <a href="/profile/{{$is_follow->user->username}}"><div class="imageAvatar-post" style="background-image: url('../storage/upload/{{ $is_follow->user->avatar }}');"></div></a>
      </div>
    </div>
      ...
      <div class="post card" style="border:1px solid rgba(0, 0, 0, 0.05);">
        <div class="card-body py-2">
          <div class="row">
            <div class="col-6">
              <div class="user-post">
                <a href="/profile/{{$is_follow->user->username}}">{{ $is_follow->user->display_name }}</a>
              </div>
            </div>
              ...
              <div class="col-2 pl-4">
                <div class="avatar-comment">
                  <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id }}">
                    <a href="/profile/{{$is_follow->user->username}}"><div class="imageAvatar-comment" style="background-image: url('../storage/upload/{{ Auth::user()->avatar }}');"></div></a>
                </div>
              </div>
